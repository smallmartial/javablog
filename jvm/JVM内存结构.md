...
![img](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/166786b5cf6d7f95)
...
* 使用句柄的方式
  ...
  ![通过句柄方式访问对象](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/955ac97ce62d2deb57356f1aee43f33a.jpeg)
   ...
   * 使用直接指针的方式（Hotspot 使用方式）
     ...
     ![通过直接指针方式访问对象](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/ee322420543cd38485ba6e1ae665ac82.jpeg)
...
![image-20191211162736253](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211162736253.png)

![image-20191211163216509](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211163216509.png)

如果在上面的代码中：` list.add(new MyTest1());` 调用 `System.gc()`;然后再次执行该程序，这时会在 JVisualVM 的左边本地进程中多一个该程序的进程，点击打开之后

首先可以看到概述以及 JVM 参数

![image-20191211164809109](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211164809109.png)

然后可以在监视中查看，其他线程和抽样器均可以可视化的查看程序运行信息；

![image-20191211164902563](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211164902563.png)
...
![image-20191211171420096](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211171420096.png)
...
![image-20191211182158268](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211182158268.png)

同样在 JVisualVM 中会自动提示检测到死锁，并且按照提示在线程选项中生成一个线程 Dump，然后查看上面的两个线程，发现他们分别已经锁定了自己的 Class 对象，想锁定对方的 Class 对象；

![image-20191211183809571](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211183809571.png)
...
![image-20191211193600512](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211193600512.png)

使用 JVisualVM 可以查看元空间增长情况

![image-20191211193944968](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211193944968.png)
...
![image-20191211205050818](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211205050818.png)
...
![image-20191211205017818](JVM%E5%86%85%E5%AD%98%E7%BB%93%E6%9E%84/image-20191211205017818.png)
